<div>
    ...
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between align-center ">
       
        <div class="flex justify-between flex-1 items-center align-center">
            <div>
                ...
                <span class="relative z-0 inline-flex rounded-md shadow-sm">
                    ...
                    <span class="flex items-center"
                        ...
                        <span aria-current="page">
                            <span
                                class="z-10 bg-indigo-50 border-indigo-500 place-self-center text-indigo-600 relative inline-flex items-center px-4 py-2 border text-sm font-medium">{{
                                $page }}</span>
                        </span>
                        @else
