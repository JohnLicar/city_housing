<div>
    ...
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
        ...
        <div class="flex justify-between flex-1 sm:items-center">
            <div>
                ...
                <span class="relative z-0 inline-flex rounded-md shadow-sm">
                    ...
                    <span
                        ...
                        <span aria-current="page">
                            <span
                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-500 bg-white border border-gray-300 cursor-default select-none">{{
                                $page }}</span>
                        </span>
                        @else
