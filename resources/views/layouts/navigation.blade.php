<aside
    ...
    <div class="py-4">
        <div>
            <p class="mt-5 ml-6 text-lg font-medium text-black">
                Main Menu
            </p>
            <ul class="mt-4 ">
                ...
                {{-- <li class="relative px-6 py-2">
                    <x-nav-link href="{{ route('housingprojects.index') }}"
                        class="{{ request()->routeIs('housingprojects.*') ? 'text-[#5283F1]' : 'text-[#525252]' }}"
        ...
        <div class="fixed w-64 bottom-0 pb-3.5 left-0 bg-white border-2 ">
            <div class="flex items-center px-3">
                <div class="flex-shrink-0 w-16 h-16">
                    <img src="{{ asset('images/logo.jpg') }}" class="w-16 h-16 mx-2 rounded-full" />
                </div>
                <div class="ml-4 text-base leading-4">
                    ...
                    <div class="w-32 overflow-hidden text-sm text-gray-500 text-ellipsis">
                        {{ auth()->user()->email }}
                    </div>
                </div>
            </div>
