<div class="mt-5 mb-5">
  ...
  <div class="relative flex justify-between">
    ...
    <div class="right-0 flex justify-end w-3/4 gap-3 sm:w-1/2">
      ...
      <x-input wire:model.debounce.400ms="search" id="search" class="w-1/3 mb-4 righ-0" type="text" name="search"
        ...
        <x-table.row wire:key="{{$applicant->id}}" wire:loading.class="opacity-50 ">
          ...
          <x-table.cell class="cell">
            <div class="flex justify-between gap-1 ">
              <div class="w-full font-medium transform text-blue-1000 hover:text-blue-900 hover:scale-110 ">
